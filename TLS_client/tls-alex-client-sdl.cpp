// To Compile
// g++ tls-alex-client-sdl.cpp make_tls_client.cpp tls_client_lib.cpp tls_pthread.cpp tls_common_lib.cpp -pthread -lssl -lcrypto -lSDL2 -o tls-alex-client-final
